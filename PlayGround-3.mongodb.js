...
// Obtén todos los productos de la marca "Samsung" 
// y que tenga 3 colores disponibles. todos los productos con un 
// precio mayor a 1000.Encuentra todos los productos con un precio 
// mayor a 1000.
...
// Obtener la marca y modelo de los productos que tengan una cámara 
// frontal con una resolución de 20MP
db.moviles.find(
  {
    "especificaciones.camaras.resolucion": '20MP',
    "especificaciones.camaras.tipo": 'Frontal',
  },
  {
    marca: 1, modelo: 1, _id: 0,
  }
);
// Mejor así para no escribir demasiado
db.moviles.find(
  {
